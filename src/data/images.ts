...
/** Hero carousel — distinct cinematic slides. */
export const HERO_SLIDES: { key: PhotoKey; title: string; sub: string }[] = [
  { key: 'pepperoni', title: 'Pizza with fire in it.', sub: 'Double pepperoni, blistered crust, straight from the wood oven.' },
  { key: 'cheesepull', title: 'That cheese pull.', sub: 'Fior di latte stretched over San Marzano tomato.' },
  { key: 'family', title: 'Feed the whole table.', sub: 'Family boxes built for sharing — and saving.' },
